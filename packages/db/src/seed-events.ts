    ...
    const seededEvents = await db.insert(events).values([
      {
        ...
        address: 'Parc de la Ciutadella, Paseo de Picasso, 21, 08003 Barcelona, Spain',
        imageUrl: 'https://images.unsplash.com/photo-1501281668745-f7f57925c3b4',
        startDate: now,
        endDate: in2Hours,
        metadata: JSON.stringify({ rating: 4.8, reviewsCount: 120, website: 'https://midnight.music', capacity: 5000 }),
        location: sql`ST_SetSRID(ST_MakePoint(2.1864, 41.3881), 4326)`,
      },
      {
        venueId: venue.id,
        ...
        address: 'Paseo de Lluís Companys, 08003 Barcelona, Spain',
        imageUrl: 'https://images.unsplash.com/photo-1555939594-58d7cb561ad1',
        startDate: now,
        endDate: tomorrow,
        metadata: JSON.stringify({ rating: 4.9, reviewsCount: 85, website: 'https://midnight.food', capacity: 1200 }),
        location: sql`ST_SetSRID(ST_MakePoint(2.1840, 41.3910), 4326)`,
      },
      {
        venueId: venue.id,
        ...
        address: 'Calle del Comercio, 36, 08003 Barcelona, Spain',
        imageUrl: 'https://images.unsplash.com/photo-1460666819451-7410f5ef13ac',
        startDate: tomorrow,
        endDate: new Date(tomorrow.getTime() + 48 * 60 * 60 * 1000),
        metadata: JSON.stringify({ rating: 4.5, reviewsCount: 42, website: 'https://midnight.art', capacity: 300 }),
        location: sql`ST_SetSRID(ST_MakePoint(2.1820, 41.3860), 4326)`,
      }
    ]).returning();
