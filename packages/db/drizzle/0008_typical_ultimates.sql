...
--> statement-breakpoint
ALTER TABLE "nodes" DROP CONSTRAINT "nodes_event_id_events_id_fk";
--> statement-breakpoint
ALTER TABLE "passkey_credentials" DROP CONSTRAINT "passkey_credentials_user_id_users_id_fk";
--> statement-breakpoint
ALTER TABLE "path_segments" DROP CONSTRAINT "path_segments_event_id_events_id_fk";
--> statement-breakpoint
ALTER TABLE "path_segments" DROP CONSTRAINT "path_segments_source_node_id_nodes_id_fk";
--> statement-breakpoint
ALTER TABLE "path_segments" DROP CONSTRAINT "path_segments_target_node_id_nodes_id_fk";
--> statement-breakpoint
ALTER TABLE "points_of_interest" DROP CONSTRAINT "points_of_interest_event_id_events_id_fk";
--> statement-breakpoint
ALTER TABLE "saved_locations" DROP CONSTRAINT "saved_locations_user_id_users_id_fk";
--> statement-breakpoint
ALTER TABLE "telemetry_logs" DROP CONSTRAINT "telemetry_logs_user_id_users_id_fk";
--> statement-breakpoint
ALTER TABLE "telemetry_logs" DROP CONSTRAINT "telemetry_logs_event_id_events_id_fk";
--> statement-breakpoint
