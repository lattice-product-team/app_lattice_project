...
Centralize environment configuration in a single root `.env` file and automate prefixing for Expo (mobile) variables to prevent configuration drift and manual maintenance errors.
