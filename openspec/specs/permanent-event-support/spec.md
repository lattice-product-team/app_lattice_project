# Capability: Permanent Event Support

## Purpose
Manage events that act as long-term or perpetual spatial containers, replacing the legacy Venue concept for fixed locations.
