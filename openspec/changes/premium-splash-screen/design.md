...
**Non-Goals:**
- Modifying the system splash screen (managed by Expo/Native). This change focuses on the *app-level* splash screen that appears immediately after the system splash.
