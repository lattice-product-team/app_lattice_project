...
- **Detección de Nivel Pasiva**: Solo se notificará a React del cambio de nivel al _finalizar_ la animación (en el `onEnd` del gesto o vía `withSpring` callback) para lógica de negocio, no para renderizado.
