...
- **Decision**: Render Event pins as absolute-positioned React components in an overlay layer _on top_ of the map, instead of using internal `MarkerView` or `SymbolLayer`.
