...
# Lattice Command Center: Admin User Guide
...
<Callout type="info" emoji="♿">
  **Accessibility Matters**: Keeping the `Wheelchair Accessible` flags accurate prevents the mobile routing engine from recommending hazardous paths to mobility-impaired attendees.
</Callout>
