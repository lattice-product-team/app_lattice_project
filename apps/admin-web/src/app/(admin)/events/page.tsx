                    ...
                    {boundaryPoints.length > 0 && (
                      <div className="flex gap-2">
                        ...
                        <Button
                          size="sm"
                          variant="compact"
                          className="bg-white/90 text-ember shadow-sm"
          ...
          <table className="w-full text-left border-collapse min-w-[1300px]">
            <thead>
              <tr className="border-b border-chalk bg-powder/50">
                ...
                <th className="py-4 px-6 text-gravel uppercase text-[10px] tracking-widest font-black whitespace-nowrap">
                  Schedule
                </th>
                <th className="py-4 px-6 text-gravel uppercase text-[10px] tracking-widest font-black">
                  Occupancy (Live)
                    ...
                    >
                      ...
                      <td className="py-6 px-6">
                        <div className="flex flex-col max-w-[200px]">
                          <span className="text-admin-base font-bold text-obsidian">
                          ...
                          <span
                            ...
                            title={event.address}
                          >
                            {event.address || 'Coordinates pending...'}
                          </span>
                        </div>
                      </td>
                      <td className="py-6 px-6">
