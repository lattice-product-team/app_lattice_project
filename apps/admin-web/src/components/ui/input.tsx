  ...
  return (
    <HeroInput
      className={cn(
        ...
        variant === 'contained' &&
          '[&_[data-slot=input-wrapper]]:bg-white [&_[data-slot=input-wrapper]]:border [&_[data-slot=input-wrapper]]:border-chalk [&_[data-slot=input-wrapper]]:shadow-subtle-3',
        variant === 'transparent' &&
          '[&_[data-slot=input-wrapper]]:bg-transparent [&_[data-slot=input-wrapper]]:border-b [&_[data-slot=input-wrapper]]:border-obsidian [&_[data-slot=input-wrapper]]:shadow-none',
        // Input styling
        ...
        userClassNames?.inputWrapper &&
          `[&_[data-slot=input-wrapper]]:${userClassNames.inputWrapper}`,
