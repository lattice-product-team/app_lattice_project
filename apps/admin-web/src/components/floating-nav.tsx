...
export function FloatingSidebarToggle() {
  ...
  return (
    ...
    >
      ...
      <span className="text-[10px] font-medium uppercase tracking-[0.15em]">Menu</span>
    </button>
  );
}
...
export function FloatingNav() {
  ...
  return (
    <nav className="flex items-center">
      <div className="bg-surface border border-border shadow-hairline rounded-full px-2 py-1.5 flex items-center gap-2 transition-colors duration-300">
        {NAV_ITEMS.map((item) => {
