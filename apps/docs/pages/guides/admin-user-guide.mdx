...
![Admin Portal Login](/app_lattice_project/assets/screenshots/admin/login.png)
...
![Global Map Overview](/app_lattice_project/assets/screenshots/admin/map.png)
...
![Event Dashboard](/app_lattice_project/assets/screenshots/admin/event-dashboard.png)
*Figure 2.2: Event Administration Grid*

![POI Dashboard](/app_lattice_project/assets/screenshots/admin/poi-dashboard.png)
...
![Event Map Inspector](/app_lattice_project/assets/screenshots/admin/map-event.png)
...
![POI Map Inspector](/app_lattice_project/assets/screenshots/admin/map-poi.png)
...
![Layer Menu Control](/app_lattice_project/assets/screenshots/admin/map-menu.png)
...
![Crowd Telemetry Radar](/app_lattice_project/assets/screenshots/admin/map-event-radar.png)
...
![Event Creation Wizard](/app_lattice_project/assets/screenshots/admin/event-create.png)
...
![Event Editor Panel](/app_lattice_project/assets/screenshots/admin/event-edit.png)
...
![POI Creator Wizard](/app_lattice_project/assets/screenshots/admin/poi-create.png)
...
![POI Editor Panel](/app_lattice_project/assets/screenshots/admin/poi-edit.png)
