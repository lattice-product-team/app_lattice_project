...
<div style={{ display: 'flex', gap: '16px', overflowX: 'auto', padding: '12px 0' }}>
  <img src="/app_lattice_project/assets/mockups/map-2.png" alt="Mobile Live Map View" style={{ height: '360px', borderRadius: '12px', boxShadow: '0 8px 30px rgba(0,0,0,0.12)' }} />
  <img src="/app_lattice_project/assets/mockups/navigation-2.png" alt="AR Navigation HUD View" style={{ height: '360px', borderRadius: '12px', boxShadow: '0 8px 30px rgba(0,0,0,0.12)' }} />
  <img src="/app_lattice_project/assets/mockups/details-pois-2.png" alt="Service Detail View" style={{ height: '360px', borderRadius: '12px', boxShadow: '0 8px 30px rgba(0,0,0,0.12)' }} />
</div>
