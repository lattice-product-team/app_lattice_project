...
<div style={{ display: 'flex', gap: '16px', overflowX: 'auto', padding: '12px 0' }}>
  <img src="/app_lattice_project/assets/mockups/details-pois-1.png" alt="POI Details Overview" style={{ height: '540px', borderRadius: '12px', boxShadow: '0 8px 30px rgba(0,0,0,0.12)' }} />
  <img src="/app_lattice_project/assets/mockups/details-pois-2.png" alt="Expanded Business Detail & Menu" style={{ height: '540px', borderRadius: '12px', boxShadow: '0 8px 30px rgba(0,0,0,0.12)' }} />
</div>
