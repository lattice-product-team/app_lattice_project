...
<div style={{ display: 'flex', gap: '16px', overflowX: 'auto', padding: '12px 0' }}>
  <img src="/app_lattice_project/assets/mockups/map-2.png" alt="Dynamic Map Interface" style={{ height: '540px', borderRadius: '12px', boxShadow: '0 8px 30px rgba(0,0,0,0.12)' }} />
  <img src="/app_lattice_project/assets/mockups/explore-1.png" alt="Fuzzy Search & Explore View" style={{ height: '540px', borderRadius: '12px', boxShadow: '0 8px 30px rgba(0,0,0,0.12)' }} />
  <img src="/app_lattice_project/assets/mockups/map-black-1.png" alt="Map Dark Mode Showcase" style={{ height: '540px', borderRadius: '12px', boxShadow: '0 8px 30px rgba(0,0,0,0.12)' }} />
  <img src="/app_lattice_project/assets/mockups/map-white-1.png" alt="Map Light Mode Showcase" style={{ height: '540px', borderRadius: '12px', boxShadow: '0 8px 30px rgba(0,0,0,0.12)' }} />
</div>
