...
- **Racing Logo Header**: A custom racing-helmet icon styled with a linear gradient and glowing shadow, alongside the title _"Welcome to the Grid"_.
...
- **Information Helper Banner**: Combines instructions for users (_"Use the 8-digit code found on your physical pass or email confirmation"_).
...
- **Footer Status Tag**: Displays a subtle spin animated badge showing _"AR Experience Ready"_, verifying that local hardware sensors support augmented reality.
