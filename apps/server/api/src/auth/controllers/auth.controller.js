import { db, users, tickets, events, passkeyCredentials, eq } from '@app/db';
...
export const ticketSync = async (req, res) => {
...
export const unclaimTicket = async (req, res) => {
  const { ticket_code } = req.body;
  const authHeader = req.headers.authorization;
  const decoded = verifyToken(authHeader.substring(7));
  const userId = decoded.userId;
 ...
 */
export const registerPasskeyChallenge = async (req, res) => {
 ...
 */
export const registerPasskeyVerify = async (req, res) => {
 ...
 */
export const loginPasskeyChallenge = async (req, res) => {
 ...
 */
export const loginPasskeyVerify = async (req, res) => {
  const { id, response } = req.body;
  try {
