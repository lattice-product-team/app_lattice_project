 ...
 */
export declare const getEventConfig: (
  req: Request,
  res: Response
...
export declare const claimTicket: (
  req: Request,
  res: Response
) => Promise<Response<any, Record<string, any>> | undefined>;
export declare const ticketSync: (
  req: Request,
  res: Response
) => Promise<Response<any, Record<string, any>> | undefined>;
...
export declare const unclaimTicket: (
  req: Request,
  res: Response
) => Promise<Response<any, Record<string, any>> | undefined>;
/**
 ...
 * Social Login: Apple
 */
export declare const appleLogin: (
  req: Request,
  res: Response
) => Promise<Response<any, Record<string, any>> | undefined>;
/**
 ...
 */
export declare const loginPasskeyVerify: (
  req: Request,
  res: Response
) => Promise<Response<any, Record<string, any>> | undefined>;
